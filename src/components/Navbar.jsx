...
const Navbar = () => {
  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 sticky top-0 right-0 left-0">
        <div className="navbar bg-base-100">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-extrabold cursor-pointer">किताब कोष</a>
          </div>
